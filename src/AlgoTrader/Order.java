...
public class Order {
    ...
    /** The date this Order arrived.  */
    private String ArriveDate;

    /** The trading strategy used by the AlgoTrader */
    ...
    /** Allowed strategies **/
    private static Set<String> allowedStrategies;
    ...
    public static void initialize() throws Exception {
        String strategiesConfig = Configuration.getInstance().getString("STRATEGIES");
        
        try {
            allowedStrategies = new HashSet<String>();
            allowedStrategies.addAll(Arrays.asList(strategiesConfig.split(" ")));
        } catch ( Exception e ) {
            throw e;
        }
    }
    ...
    public Order (String oID, String s, String c, String sID, String a,
                  double p, double q, double aq, char buySell, String strat,
    ...
    /**
     * @param strat Strategy
     * @throws DataFormatException If strat is not in STRATEGIES in AlgoTrader.cfg 
     */
    public void setStrategy ( String strat ) throws DataFormatException
    {
        if ( allowedStrategies.contains(strat) )
            Strategy = strat;
        else
            throw new DataFormatException(strat +
            " is not a valid time strategy");
    }
